        ...
        <div class="row">
            <div class="container" style="width: 25%;float: left;font-family: 'roboto';font-size: 20px;">
                ...
                <div class="card">
                  <div class="list-group" style="padding: 10px;">
                      <a>Bộ lọc
                      <div class="bi-funnel" style="float: right;font-size: 25px"></div>
                      </a>
                  </div>
                  <div class="list-group dropend">
                      <form action="/timtheogia" class="p-2" method="POST">
                        @csrf
                        @method('GET')
                        <input type="submit" value="Dưới 10.000đ" name="name" class="p-2 form-control list-group-item-action btn-outline-primary">
                        <input type="submit" value="Từ 10.000đ đến 20.000đ" name="name" class="p-2 form-control list-group-item-action btn-outline-primary">
                        <input type="submit" value="Từ 20.000đ đến 30.000đ" name="name" class="p-2 form-control list-group-item-action btn-outline-primary">
                      </form>
                  </div>
              </div>
              <br><br>
